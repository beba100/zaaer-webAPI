...
{
    /// <summary>
    /// Saves POS outlet item images under <c>wwwroot/uploads/pos-items/{hotelId}/</c>.
    /// </summary>
    public static class PosItemImageStorage
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var relativePath = $"/uploads/pos-items/{hotelFolder}/{fileName}";
