...
INSERT INTO @p VALUES
    ...
    (N'hotel.reports', N'View hotel & resort reports', N'عرض تقارير الفندق والمنتجع', N'hotel', N'reports', N'view', 1104);
...
-- Grant hotel report permission to roles that can view the room board (same operators who run PMS daily).

DECLARE @anchorCode NVARCHAR(150) = N'room_board.view';



;WITH hotel_role_grants AS (
...
USING hotel_role_grants AS source
...
PRINT CONCAT(N'Hotel permissions granted to room_board.view roles: ', @@ROWCOUNT);
