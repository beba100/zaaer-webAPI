...
{
    /// <summary>
    /// DTO for updating a reservation via Zaaer integration
    /// </summary>
    public class ZaaerUpdateReservationDto
    {
        /// <summary>
        ...
        /// </summary>
        public List<ZaaerReservationUnitDto>? ReservationUnits { get; set; }
