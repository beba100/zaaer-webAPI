(function (window, $) {
    ...
    $(function () {
        common.initReportPage({
            navKey: "nav-hotel-report-deposits",
            reportKey: "deposits",
            titleKey: "hotelReports.title.deposits",
            exportPrefix: "hotel-deposits",
            keyExpr: "receiptId",
            load(query) {
            ...
            pdfColumns(t, fmtDate, fmtMoney) {
                return [
                    ...
                    { caption: t("hotelReports.col.amount"), field: "displayAmount", value: (r) => fmtMoney(r.displayAmount ?? r.DisplayAmount ?? r.amountPaid) },
                    { caption: t("hotelReports.col.bank"), field: "bankName", value: (r) => r.bankName || r.BankName || "" }
                ];
            },
            columns(ctx) {
                return [
                    ...
                    ctx.dateColumn("receiptDate", "hotelReports.col.docDate"),
                    {
                        dataField: "displayAmount",
                        caption: ctx.t("hotelReports.col.amount"),
                        dataType: "number",
                        alignment: "right",
                    ...
                    { dataField: "bankName", caption: ctx.t("hotelReports.col.bank") },
                    {
                    ...
                    },
                    {
                        ...
                        width: 100,
                        calculateCellValue(row) {
                            return ctx.mapReceiptStatusDisplay(row.receiptStatus ?? row.ReceiptStatus);
                        }
                    },
